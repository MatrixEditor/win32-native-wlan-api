...
/**
 * @brief The DS-Parameter set or DSSS-Parameter set defines the current 
 * channel of the AP that sends the beacon frame. The structure is as 
 * follows: (3 bytes in total)
 * 
 * +----------+-----------+------------+
 * |  ID (3)  |  LEN (1)  |  <channel> |
 * +----------+-----------+------------+
